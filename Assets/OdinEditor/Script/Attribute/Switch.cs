...
namespace rStar.Odin.Attributes
{
    ...
    #region Protected Methods
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            if (label != null && !hasToggleLeftAttribute) totalRect = EditorGUI.PrefixLabel(totalRect , label);
            ...
            if (ColorHasChanged(targetBackgroundColor , targetSwitchColor)) animating = true;
            ...
            if (evt.type == EventType.Layout && animating)
            {
                ...
                if (backgroundColor == targetBackgroundColor
                 ...
                 && switchPosition == targetSwitchPosition) animating = false;
            ...
            GUI.DrawTexture(switchBackgroundRect , whiteTexture , ScaleMode.StretchToFill , true , 0f ,
            ...
            GUI.DrawTexture(switchRect , whiteTexture , ScaleMode.StretchToFill , true , 0f ,
                            finalSwitchColor , 0f , borderRadius);

            if (hasToggleLeftAttribute) EditorGUI.LabelField(totalRect.AddX(SwitchWidth + 4f) , label);
        }
    ...
    /// <summary>
    ///     https://github.com/Schwapo/Switch
    /// </summary>
    ...
    #region Private Variables
        ...
        private static readonly string BlueColor                 = "@new Color(0.498f, 0.843f, 0.992f)";
        private static readonly string GreenColor                = "@new Color(0.6f , 1f , 0.6f)";
        private static readonly string RedColor                  = "@new Color(1f , 0.4f , 0.65f)";
        private static readonly string YellowColor               = "@new Color(1f , 0.95f , 0.4f)";
        private static          string MainColor                 = BlueColor;
        private static readonly string DefaultBackgroundColorOn  = MainColor;
        private static readonly string DefaultBackgroundColorOff = "@new Color(0.065f, 0.065f, 0.065f)";
        private static readonly string DefaultSwitchColorOn      = DefaultBackgroundColorOff;
        private static readonly string DefaultSwitchColorOff     = MainColor;
    ...
    #region Constructor
        ...
        public SwitchAttribute(bool rounded = true , DefaultColor color = Blue)
        {
            Alignment    = SwitchAlignment.Left;
            Rounded      = rounded;
            DefaultColor = color;
        ...
        public SwitchAttribute() : this(true) { }

        public SwitchAttribute(DefaultColor color = Blue) : this(true , color) { }
    ...
    #region Private Methods
                ...
                string switchColorOff     = null)
        {
            ...
            BackgroundColorOn  = backgroundColorOn ?? MainColor;
            ...
            SwitchColorOff     = switchColorOff ?? backgroundColorOn ?? MainColor;
        }
